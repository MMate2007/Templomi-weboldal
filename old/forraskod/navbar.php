<nav id="desktop">
<a id="elso" href="http://www.peldaplebania.hu/index.php">Főoldal</a>
<a href="http://www.peldaplebania.hu/miserend.php">Liturgiák rendje</a>
<a href="http://www.peldaplebania.hu/history.php">Templomunkról</a>
<a href="http://www.peldaplebania.hu/kapolna.php">Kápolnánkról</a>
<a href="http://www.peldaplebania.hu/images.php">Képek</a>
<a href="http://www.peldaplebania.hu/blog.php">A fília blogja</a>
<a href="http://www.peldaplebania.hu/usefull.php">Hasznosságok</a>
<?php
session_start();
if (!isset($_SESSION["userId"]))
{
	?>
    <a href="http://www.peldaplebania.hu/imak.php">Imádságok</a>
    <a href="http://www.peldaplebania.hu/index.php#info">Közérdekű információk</a>
    <?php
}
?>
<a href="http://www.peldaplebania.hu/login.form.php" id="right-elso" class="right">Bejelentkezés</a>
</nav>
