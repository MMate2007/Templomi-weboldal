<html>
<head>
<title>Hirdetés létrehozása - Példa plébánia</title>
<meta charset="utf-8">
...
<div class="head-text">
<h1>Példa plébánia honlapja - Hirdetés létrehozása</h1>
</div>
</div>
</div>
<hr>
...
<strong><a href="form.create.hirdetes.php" class="right">Hirdetés létrehozása</a></strong>
...
<tr>
<td><label></label></td>
<td><input type="submit" value="Közzététel"></form><form action="form3.create.hirdetes.php" method="post"><input type="hidden" name="title" value="<?php echo $title; ?>">
<input type="hidden" name="content" value="<?php echo $content; ?>"><input type="submit" value="Vissza"></form></td>
<td><label></label></td>
</tr>
</table>
</form>
